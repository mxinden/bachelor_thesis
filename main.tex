...
% Table of contents
\tableofcontents
\texthl{M\"ussen alle Kapitel die gleiche \"Uberschriftentiefe habe?}
...
\begin{content}
  ...
  Für die Analyse von Unternehmensdaten müssen diese zunächst modelliert
  werden. \textsc{\citeauthor{phipps2002automating}} zählen die Modellierung
  der Daten zu den fünf essentiellen Schritten für die Datenanalyse im
  Data-Warehouse-Kontext~\cite[][S. 1]{phipps2002automating}. Es sollen nun
  zwei verschiedene Modelltypen beleutet und im Kontext der
  Unternehmensdatenanalyse miteinander verglichen werden.

  \begin{enumerate}
    \item Entity-Relationship-Modell~\cite[][Kapitel 6.3]{ballard1998data}
    \item Dimensions-Modellierung~\cite[][Kapitel 6.4]{ballard1998data}
  \end{enumerate}

  Laut \textsc{\citeauthor{phipps2002automating}} wird im Umgang mit
  OLTP-Systemen überwiegend auf die ER-Modellierung zurück gegriffen, wo
  hingegen OLAP-Systeme meist mit der Dimensions-Modellierung entwickelt

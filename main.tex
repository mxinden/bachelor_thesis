...
\begin{content}
  ...
  \todo{Referenz zu jemandem klugen, der Erklärt was Normalisierung ist}
  ...
  mit seinem \texthl{Paper} \todo{Artikel?} \glqq{}The entity-relationship
  ...
  \todo[inline]{Mache Verweis zu weiteren Quellen zum Nachlesen über das
  Modell, \zB{} ballard1998data, oder 161 von Fleischer Diss (2004 = Kardinalität, 2012 = Disjunkt, Total)}
  \todo[inline]{ggf.~zitieren: Datenmodelle, Datenbanksprachen und
  Datenbankmanagementsysteme von Gottfried Vossen}

  \todo{Diese Grafik im Vergleich zu entsprechendem Multidimensionalen Modell darstellen/erweitern}
...
\texthl{Wie finden andere das Tool, Feedback dokumentieren, ggf. mit Fragebogen}

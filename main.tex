...
\begin{content}
  ...
  \paragraph{Funktionale Ziele}
    \begin{enumerate}
      ...
      \item \textbf{Definition von Datenqualitätskennzahlen} 
  ...
  sowohl innerhalb einer Instanz als auch über mehrere hinaus aggieren. Ein
  ...
  \todo[inline]{Noch zusätzlich auf andere Funktionen wie \zB{} notEmpty oder
  contains eingehen}

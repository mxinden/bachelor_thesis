...
\begin{content}
  ...
  Hierzu wird auf die Vorgehensweise der
  \textit{zielorientierten Anforderungsanalyse}, näher beschrieben von
  \textsc{\citeauthor{van2001goal}}, zurück gegriffen~\cite[][]{van2001goal}.
  Ziele werden unterschieden in \textit{funktionale} und \textit{nicht-funktionale} Ziele~\cite[][S. 36]{mylopoulos1999object}. Erstere beschreiben die Leistungen der Sprache selbst, zweitere beschäftigen sich mit der Art und Weise \bzw{} mit der Qualität der Leistung~\cite[][S. 250]{van2001goal}.

  \begin{itemize}
    \item Funktionale Anforderungen
      \begin{itemize}
        \item Bestehende Datenstrukturen von Unternehmensdaten in
          hierarchischer Form modellieren und gliedern
        \item Datenqualitäts- und Unternehemenskennzahlen spezifizieren zur
          Anwendung auf die Unternehmensdaten
        \item Berichtstrukturen aus Daten und Kennzahlen kombinieren
      \end{itemize}
    \item Nicht-funktionale Anforderungen
      \begin{itemize}
        \item Vokabular der Sprache \~= Vokabular von DataRocket
        \item Vokabular an Schnittpunkten übereinstimmen
        \item Die Sprache ist bewusst schlicht gehalten um mit dem USP von
          \textit{DataRocket}, \acrshort{DQM} IT-Laien zu ermöglichen, kohärent
          zu bleiben. Leicht verständlich
      \end{itemize}
    \item Annahmen
      \begin{itemize}
        \item Eingangsdaten sind hierarchisch strukturiert
        \item Die Unternehmensdaten können in jegliche gewünschte Struktur
          transformiert werden (technische Transformation nicht Teil dieser BA)
      \end{itemize}
  \end{itemize}
  ...
  Compiler, Railroad-Diagram, horizontale Linien gleich Gleise}}

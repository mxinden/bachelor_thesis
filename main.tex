...
\begin{content}
  ...
  \section{Stammdatenmanagement}
	Das Stammdatenmanagement strebt eine langfristig hohe Datenqualität der
	Stammdaten an und beinhaltet sowohl den organisatorischen als auch
	technischen Umgang in einem Unternehmen~\cite[][S.  2]{legner2007stammdaten}.
	Die Definition von Prozessen im Umgang mit Stammdaten gehört \zB{} zum
	organisatorischen Stammdatenmanagement, wohingegen der Einsatz eines
	Stammdatenmanagement-Tools wie \textit{DataRocket} zum technischen
	Stammdatenmanagement gezählt werden kann.  Das Thema steigt laut
	\textsc{\citeauthor{otto2012design}} sowohl in der Wissenschaft als auch in
	der Praxis in seiner Relevanz~\cite[][S.  1]{otto2012design}.  \todo{Fakten
	einer Umfrage}
	...
	werden~\cite[][S. 1 f.]{otto2012design}.  Neben ihrer zentralen Nutzung
	...
	\textit{Produkte}~\cite[][S. 1]{knolmayer2006quality}.

	Die Datenqualität von Stammdaten lässt sich anhand von verschiendenen
	Qualitätsdimensionen genauer spezifizieren.
	\textsc{\citeauthor{pipino2002data}} nennt \zB{} \textit{Fehlerfreiheit},
	...
	Dimensionen~\cite[][S. 213 f., S. 4 f.]{pipino2002data, legner2007stammdaten}.


  Wofür wird Datenqualitätsmanagement benötigt?
  \subsection{Datenqualität}
  Datenkonsistenz
  Wie misst sich Datenqualität? Durch \textbf{Kennzahlen}
	"Only what can be measured can be improved"\cite{baghi2013controlling}
	\begin{enumerate}
	...
	\end{enumerate}\cite{legner2007stammdaten}

  \subsection{Wie lässt sich Datenqualität verbessern?}

...
\begin{content}
  ...
  \subsection{IBM}
  \begin{figure}[caption={Metamodell der IBM-Dimensions-Sprache}, label={fig:img01}]
    \resizebox{\columnwidth}{!}{\input{content/figures/IBM-dimension-modelling-language.tex}}
  \end{figure}
  Zwei Methoden
  \begin{itemize}
    \item er modelling---IBM~\cite[][Kapitel 6.3]{ballard1998data}
    \item dimensional modelling---IBM~\cite[][Kapitel 6.4]{ballard1998data}
  \end{itemize}

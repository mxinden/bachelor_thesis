...
\begin{content}
  ...
  \section{Vorstellung \textit{DataRocket}}
	...
	\begin{enumerate}
		...
		Attribute \textit{Name} und \textit{Adresse} hat. Zusätzlich besitzt es
		...
		3]{becker2006konzeptionelle}.\todo{Nicht direkt Sollmodellierung, nur in
		Datenmigrationsprojekten, alternativen Begriff suchen}

		\item Qualitätskennzahlen werden spezifiziert.
		\item Analyse 
		\item Visualisierung
	...
	\todo[inline]{Plan- und Soll-Modellierung zitieren}
